...
@ModuleManifest(label = "DevCrystalAura", category = ModuleCategory.COMBAT, color = 0x4BF7FF)
public class DevCrystalAura extends ToggleableModule {
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        if (place) {
            ...
            if (System.nanoTime() / 1000000L - placeSystemTime >= placeDelay * 2) {
                ...
                this.placeLocations.add(new PlaceLocation(finalPos.getX(), finalPos.getY(), finalPos.getZ(), (float) damage));
                render = finalPos;
